...
class EduDocApp(QWidget):
    ...
    def initUI(self):
        ...
        self.file_button.setStyleSheet('background: #2476FF; color: black; border: none; border-radius: 30px; padding: 10px;')
        ...
        self.gen_audio_button.setStyleSheet('background: #2476FF; color: black; margin-top: 10px; border: none; border-radius: 30px; padding: 10px;')
        ...
        self.audio_slider.setStyleSheet("""
        ...
        # Frame to surround the audio_slider and time_label
        audio_frame = QFrame()
        audio_frame_layout = QVBoxLayout()
        audio_frame_layout.addWidget(self.audio_slider, alignment=Qt.AlignCenter)
        audio_frame_layout.addWidget(self.time_label, alignment=Qt.AlignCenter)
        audio_frame.setLayout(audio_frame_layout)
        audio_frame.setStyleSheet('background-color: #DEE7FA; border: 2px solid #DEE7FA; border-radius: 30px; padding: 10px;')
        audio_layout.addWidget(audio_frame, alignment=Qt.AlignCenter)
        ...
        self.save_audio_button.setStyleSheet('background: #2476FF; color: black; margin-top: 10px; border: none; border-radius: 30px; padding: 10px;')
        ...
        self.gen_video_button.setStyleSheet('background: #2476FF; color: black; margin-top: 10px; border: none; border-radius: 30px; padding: 10px;')
        ...
        self.play_video_button.setStyleSheet('background: #2476FF; color: black; margin-top: 10px; border: none; border-radius: 30px; padding: 10px;')
        ...
        qdoc_layout.setContentsMargins(100, 0, 50, 0)
        qdoc_layout.setSpacing(100)
        ...
        self.chatbot_output.setFixedHeight(420)
    ...
    def query_document(self):
        ...
        if user_question:
            ...
            self.add_chat_message(result.content+"\n", False)
